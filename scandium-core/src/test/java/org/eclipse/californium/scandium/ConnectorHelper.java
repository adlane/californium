...
public class ConnectorHelper {
	...
	public void startServer(DtlsConnectorConfig.Builder builder) throws IOException, GeneralSecurityException {
		...
		serverConnectionStore = new DebugConnectionStore(builder.getIncompleteConfig().getConnectionIdLength(), SERVER_CONNECTION_STORE_CAPACITY, 5 * 60, serverSessionCache); // connection timeout 5mins
